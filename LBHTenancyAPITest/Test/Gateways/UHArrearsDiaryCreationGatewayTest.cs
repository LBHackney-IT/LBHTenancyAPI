...
namespace LBHTenancyAPITest.Test.Gateways
{
    public class UHArrearsDiaryCreationGatewayTest
    {
        ...
        [Fact]
        public void Given_TenancyAgreementRef_When_CreateActionDiaryEntry_WithCorrectParameters_Should_BeTrue()
        {
            //Test will be testing that the correct data types are being sent to the mocked webservice
            //Assert against the response object being sent back.

            //Arrange
            IArrearsActionDiaryGateway classUnderTest = new ArrearsActionDiaryGateway();
            ...
            //act
            var response = classUnderTest.CreateActionDiaryEntry();
            //assert
